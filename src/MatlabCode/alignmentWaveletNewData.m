...
% It shouldn't be in the published src code...
  ...
  if nargin < 7 % doesn't have data
      EXPR_INDEX = [32, 33, 34, 36, 37, 38];
      id_str = int2str(EXPR_INDEX(EXPR_ID));
      
      DATA_PATH = 'C:/Users/zhhsp/Documents/HeartRate/wearable-raw-data/5min_Data/Huihuang_format/';
      DATA_FILES = {[DATA_PATH, 'gear_up/', id_str, '_watch_acc.txt'], ...
                   [DATA_PATH, 'moto_down/', id_str, '_watch_acc.txt'], ...
                   [DATA_PATH, 'gear_up/', id_str, '_watch_gyro.txt'], ...
                   [DATA_PATH, 'moto_down/', id_str, '_watch_gyro.txt'], ...
                   [DATA_PATH, 'rawBeatData-', id_str, '.csv'], ...
                   [DATA_PATH, 'rawHRData-', id_str, '.csv'], ...
                  };
